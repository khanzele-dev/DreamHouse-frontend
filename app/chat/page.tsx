...
export default function ChatPage() {
  ...
  // Используем mounted для безопасного применения мобильных стилей
  const mobileStyles = mounted ? isMobile : false;
  ...
  function ChatContent() {
    return (
      ...
      >
        {mounted && !mobileStyles && (
          <aside className='content-center justify-center'
            style={{
              width: "280px",
              background: "#6f88ff",
              padding: "24px",
        ...
        >
          <div
            onClick={() => router.push("/")}
            style={{
              padding: mobileStyles ? "16px 12px" : "20px 24px",
              color: "#8fa1ff",
          ...
          <div
            style={{
              ...
              flexDirection: "column",
              alignItems:
                allMessages.length === 0 && !isLoading ? "center" : "stretch",
              justifyContent:
                allMessages.length === 0 && !isLoading
                  ? "center"
                  : "flex-start",
              padding: mobileStyles ? "0 12px" : "0 24px",
            }}
          >
            {isLoadingHistory ? (
              <div style={{ textAlign: "center", padding: "40px 0" }}>
                <div
                  style={{
                    ...
                    height: "48px",
                    margin: "0 auto 16px",
                    border: "4px solid #6f88ff",
                    borderTopColor: "transparent",
                    borderRadius: "50%",
                    animation: "spin 1s linear infinite",
                  }}
                />
                <p style={{ color: "#8fa1ff", fontSize: "14px" }}>
                  Загрузка истории...
                </p>
              </div>
            ) : allMessages.length === 0 && !isLoading ? (
              ...
              >
                ...
                >
                  ...
                  <span>Задайте новый вопрос</span>
                </div>
              </div>
            ) : (
              <div
                  ...
                  >
                    ...
                    >
                      <div
                        style={{
                          ...
                          background:
                            "linear-gradient(135deg, #6f88ff, #8fa1ff)",
                          color: "white",
                    ...
                    {msg.response && (
                      ...
                      >
                        <div
                          style={{
                          maxWidth: mobileStyles ? "90%" : "85%",
                          borderRadius: "16px",
                          padding: mobileStyles ? "10px 14px" : "12px 16px",
                          backgroundColor: "#1c1d21",
                          color: "#fff",
                          fontSize: mobileStyles ? "13px" : "14px",
                            lineHeight: "1.5",
                            whiteSpace: "pre-wrap",
                          }}
                        >
                      ...
                      msg.referenced_cards.length > 0 && (
                        <div style={{ marginLeft: "0", marginTop: "8px" }}>
                          ...
                          >
                            ...
                            {msg.referenced_cards.length})
                          </p>
                          <div
                            style={{
                              display: "grid",
                          gridTemplateColumns: mobileStyles
                            ? "1fr"
                            : "repeat(auto-fill, minmax(280px, 1fr))",
                          gap: mobileStyles ? "12px" : "16px",
                            }}
                          >
          ...
          >
            <div
              style={{
                width: mobileStyles ? "100%" : "70%",
                maxWidth: "700px",
                background: "#1c1d21",
                borderRadius: "16px",
                padding: mobileStyles ? "12px" : "16px",
                display: "flex",
                alignItems: "center",
                gap: "12px",
              }}
            >
              <input
                ...
                placeholder="Сколько стоит квартира в районе моря?"
                disabled={isLoading}
                style={{
                  flex: 1,
                  background: "transparent",
              ...
              <button
                ...
                style={{
                  ...
                  opacity: isLoading ? 0.5 : isListening ? 1 : 0.6,
                  padding: "4px",
                  display: "flex",
                  alignItems: "center",
