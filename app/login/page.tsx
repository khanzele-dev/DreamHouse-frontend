...
function LoginContent() {
  ...
  return (
    <div
      className="flex py-10 lg:p-0 lg:min-h-screen relative font-[family-name:var(--font-stetica-bold)]"
      style={{
    ...
    >
      ...
      >
        <div className="max-w-lg w-full lg:w-[450px] flex flex-col">
            ...
            >
              ...
              <div className="w-full">
                <button
                  ...
                  className="w-full text-[20px] rounded-full py-3 hover:opacity-95 transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
      ...
      >
        <path
          d="M695 0H0L222.296 707H695V0Z"
          fill="#3366CC"
          style={{ transition: "fill 0.3s ease" }}
        />
        <path
          d="M72.3264 232L0 0H134L72.3264 232Z"
          fill="#FFC860"
          style={{ transition: "fill 0.3s ease" }}
        />
      </svg>
      <div className="w-full flex-col justify-center items-center z-2 hidden lg:flex">
        <h2
          className="text-[45px] lg:text-[35px] xl:text-[45px]"
          style={{
            color: "#FFFFFF",
            transition: "color 0.3s ease",
          }}
        ...
        <p
          className="text-[20px] xl:text-[25px] w-[300px] xl:w-[380px] text-left font-[family-name:var(--font-stetica-regular)] translate-x-[-26px] xl:translate-x-[-40px]"
          style={{
            color: "#FFFFFF99",
            transition: "color 0.3s ease",
          }}
