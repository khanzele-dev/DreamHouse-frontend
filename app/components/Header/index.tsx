...
const FavoriteIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M14.1979 7.70868L13.5454 8.33702C13.6299 8.42472 13.7313 8.49449 13.8434 8.54214C13.9555 8.58979 14.0761 8.61435 14.1979 8.61435C14.3197 8.61435 14.4403 8.58979 14.5524 8.54214C14.6645 8.49449 14.7659 8.42472 14.8504 8.33702L14.1979 7.70868ZM11.0876 23.2019C9.25581 21.758 7.2536 20.3478 5.66465 18.5595C4.10831 16.805 3.02081 14.7593 3.02081 12.1034H1.20831C1.20831 15.3248 2.54956 17.7826 4.3101 19.763C6.03802 21.7084 8.24202 23.2672 9.9651 24.6253L11.0876 23.2019ZM3.02081 12.1034C3.02081 9.50547 4.48894 7.32564 6.49356 6.40852C8.4414 5.51797 11.0586 5.7536 13.5454 8.33702L14.8504 7.08156C11.9021 4.01602 8.47523 3.50972 5.73956 4.76035C3.06431 5.98439 1.20831 8.82639 1.20831 12.1034H3.02081ZM9.9651 24.6253C10.585 25.1135 11.2496 25.6331 11.9226 26.027C12.5956 26.4209 13.3641 26.7399 14.1979 26.7399V24.9274C13.8233 24.9274 13.3835 24.7824 12.8373 24.4622C12.2899 24.1432 11.7232 23.7034 11.0876 23.2019L9.9651 24.6253ZM18.4307 24.6253C20.1538 23.266 22.3578 21.7096 24.0857 19.763C25.8462 17.7813 27.1875 15.3248 27.1875 12.1034H25.375C25.375 14.7593 24.2875 16.805 22.7311 18.5595C21.1422 20.3478 19.14 21.758 17.3081 23.2019L18.4307 24.6253ZM27.1875 12.1034C27.1875 8.82639 25.3327 5.98439 22.6562 4.76035C19.9206 3.50972 16.4961 4.01602 13.5454 7.08035L14.8504 8.33702C17.3371 5.75481 19.9544 5.51797 21.9022 6.40852C23.9069 7.32564 25.375 9.50427 25.375 12.1034H27.1875ZM17.3081 23.2019C16.6726 23.7034 16.1059 24.1432 15.5585 24.4622C15.0111 24.7812 14.5725 24.9274 14.1979 24.9274V26.7399C15.0316 26.7399 15.8001 26.4197 16.4732 26.027C17.1474 25.6331 17.8108 25.1135 18.4307 24.6253L17.3081 23.2019Z"
...
const NotificationIcon = ({
  ...
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <g clipPath="url(#clip0_2135_361)">
      <path
        d="M3.05697 17.8928C2.80002 19.5278 3.94882 20.6626 5.35538 21.2281C10.7479 23.3963 18.2521 23.3963 23.6445 21.2281C25.0512 20.6626 26.1999 19.5278 25.943 17.8928C25.7851 16.8881 25.0043 16.0515 24.4257 15.2345C23.668 14.1512 23.5927 12.9697 23.5926 11.7127C23.5926 6.85483 19.5217 2.91675 14.5 2.91675C9.47831 2.91675 5.40743 6.85483 5.40743 11.7127C5.40731 12.9697 5.33202 14.1512 4.57426 15.2345C3.99575 16.0515 3.21489 16.8881 3.05697 17.8928Z"
      ...
      />
      <path
        d="M10.875 25.875C11.837 26.6265 13.1074 27.0833 14.5 27.0833C15.8926 27.0833 17.163 26.6265 18.125 25.875"
        stroke="var(--accent-primary)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
const HelpIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M26.5834 14.4765C26.5834 20.8604 21.1727 26.0363 14.5 26.0363C13.7155 26.0374 12.9331 25.9647 12.1624 25.8201C11.6077 25.7158 11.3303 25.6637 11.1367 25.6933C10.943 25.723 10.6686 25.8688 10.1198 26.1607C8.56727 26.9864 6.75696 27.278 5.01595 26.9541C5.67767 26.1402 6.12959 25.1636 6.32901 24.1167C6.44984 23.4763 6.15044 22.8542 5.70201 22.3988C3.66529 20.3306 2.41669 17.5437 2.41669 14.4765C2.41669 8.09273 7.82734 2.91675 14.5 2.91675C21.1727 2.91675 26.5834 8.09273 26.5834 14.4765Z"
      stroke="var(--accent-primary)"
      strokeWidth="2"
      strokeLinejoin="round"
    />
    <path
      d="M12.0833 12.3975C12.0833 11.1655 13.1653 10.1667 14.5 10.1667C15.8347 10.1667 16.9166 11.1655 16.9166 12.3975C16.9166 12.8416 16.7761 13.2554 16.5337 13.603C15.8115 14.639 14.5 15.6271 14.5 16.8591V17.4167"
      stroke="var(--accent-primary)"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M14.5 20.4375H14.5075"
      stroke="var(--accent-primary)"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const ThemeToggle = ({
  ...
  >
    ...
    <circle
      ...
      fill="var(--bg-primary)"
      stroke="var(--accent-primary)"
      style={{ transition: "cx 0.3s ease, fill 0.3s ease, stroke 0.3s ease" }}
    />
  </svg>
);
...
export const Header = () => {
  ...
  return (
    <header className="w-full content-center max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-7 py-3 lg:py-0 lg:h-[80px]">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-x-8">
        <div className="w-full flex items-center justify-between lg:w-auto lg:justify-start gap-x-2 lg:gap-x-[10px]">
          ...
          <div className="flex lg:hidden items-center gap-x-4 sm:gap-x-5 flex-shrink-0">
            <Link href="/favorite">
              <FavoriteIcon className="w-[22px] h-[24px] cursor-pointer" />
            </Link>
            ...
            <SupportTooltip>
              <HelpIcon className="w-[22px] h-[24px] cursor-pointer" />
            </SupportTooltip>
            <ThemeToggle theme={theme} onClick={toggleTheme} />
            <HeaderAvatar variant="mobile" />
          </div>
        </div>
        <Search />
        <div className="hidden lg:flex flex-row justify-center items-center gap-x-6">
          <Link href="/favorite">
            <FavoriteIcon className="w-[28px] h-[30px] cursor-pointer" />
          </Link>
          <div className="relative">
            <NotificationIcon
          ...
          <SupportTooltip>
            <HelpIcon className="w-[28px] h-[30px] cursor-pointer" />
          </SupportTooltip>
        </div>
        <div className="hidden lg:flex flex-row justify-center items-center gap-x-6">
          <ThemeToggle theme={theme} onClick={toggleTheme} />
          <HeaderAvatar variant="desktop" />
        </div>
      </div>
    </header>
  );
